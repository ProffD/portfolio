        ...
        <div className="bg-white rounded-md shadow-md flex flex-row">
            ...
            <div className="px-6 py-8 h-96 w-96 max-w-3xl:hidden " id="contact_us">
                <div className="flex justify-between">
                    ...
                    {/* <h6 className="text-blue-800">{getcontactInfo()}</h6> */}
                ...
                <form ref={form} onSubmit={sendEmail}>
                    <input type="text" name="from_name" placeholder="Name" className="w-full text-xs text-black px-3 h-8 my-2 outline-none rounded-md border focus:shadow-sm" />
                    <input type="email" name="from_email" placeholder="Email" className="w-full text-xs text-black px-3 h-8 my-2 outline-none rounded-md border focus:shadow-sm" />
                    <textarea cols={10} name="message" rows={10} placeholder="Write your Message..." className="w-full text-black text-xs px-3 py-2 h-20 my-2 outline-none rounded-md border focus:shadow-sm resize-none"></textarea>
